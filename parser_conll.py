...
LTP_DATA_DIR = '../corpus/ltp_data'  # ltp模型目录的路径
...
fr = open('/home/timwang/Desktop/input.txt', 'r', encoding="utf")
...
for line in fr.readlines():
    ...
    for index, pos in enumerate(postags):
        fw.write(str(index+1) + "\t" + words[index] + "\t" + words[index] + "\t" + pos + "\t" + pos + "\t" + "_" +"\t" + "_" +"\t" + "_" + "\t" + "_" +"\t" + "_" + "\n")  # 写完通过\n进行换行
    fw.write("\n")
fw.close()
